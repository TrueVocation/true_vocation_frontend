...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './demand-profession-city.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEMANDPROFESSIONCITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEMANDPROFESSIONCITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEMANDPROFESSIONCITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEMANDPROFESSIONCITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEMANDPROFESSIONCITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEMANDPROFESSIONCITY actions', async () => {
      const expectedActions = [
        {
