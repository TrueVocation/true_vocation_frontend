...
export const LikesDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="truevocationApp.likes.delete.question">
        <Translate contentKey="truevocationApp.likes.delete.question" interpolate={{ id: likesEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="-confirm-delete-likes" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
