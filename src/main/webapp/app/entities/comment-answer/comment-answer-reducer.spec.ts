...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMENTANSWER_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMMENTANSWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMMENTANSWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMMENTANSWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMMENTANSWER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMMENTANSWER actions', async () => {
      const expectedActions = [
        {
