...
export const SpecialtyDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="truevocationApp.specialty.delete.question">
        <Translate contentKey="truevocationApp.specialty.delete.question" interpolate={{ id: specialtyEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="-confirm-delete-specialty" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
