...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UNIVERSITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_UNIVERSITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_UNIVERSITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_UNIVERSITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_UNIVERSITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_UNIVERSITY actions', async () => {
      const expectedActions = [
        {
