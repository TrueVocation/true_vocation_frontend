...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './faculty.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FACULTY_LIST actions', async () => {
    ...
    it('dispatches FETCH_FACULTY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FACULTY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FACULTY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FACULTY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FACULTY actions', async () => {
      const expectedActions = [
        {
