...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANSWERUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANSWERUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANSWERUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANSWERUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANSWERUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANSWERUSER actions', async () => {
      const expectedActions = [
        {
