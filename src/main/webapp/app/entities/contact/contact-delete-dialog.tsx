...
export const ContactDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="truevocationApp.contact.delete.question">
        <Translate contentKey="truevocationApp.contact.delete.question" interpolate={{ id: contactEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="-confirm-delete-contact" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
