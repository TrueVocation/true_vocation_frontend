...
export const PostDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="truevocationApp.post.delete.question">
        <Translate contentKey="truevocationApp.post.delete.question" interpolate={{ id: postEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="-confirm-delete-post" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
