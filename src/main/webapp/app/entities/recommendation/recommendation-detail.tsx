    ...
    <Row>
      <Col md="8">
        <h2 data-cy="recommendationDetailsHeading">
          <Translate contentKey="truevocationApp.recommendation.detail.title">Recommendation</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="truevocationApp.recommendation.profession">Profession</Translate>
          </dt>
          <dd>{recommendationEntity.profession ? recommendationEntity.profession.id : ''}</dd>
        </dl>
