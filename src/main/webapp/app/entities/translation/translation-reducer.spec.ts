...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSLATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRANSLATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSLATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSLATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSLATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSLATION actions', async () => {
      const expectedActions = [
        {
