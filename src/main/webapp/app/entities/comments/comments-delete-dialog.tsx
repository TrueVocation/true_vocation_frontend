...
export const CommentsDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="truevocationApp.comments.delete.question">
        <Translate contentKey="truevocationApp.comments.delete.question" interpolate={{ id: commentsEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="-confirm-delete-comments" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
