...
export const SchoolDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="truevocationApp.school.delete.question">
        <Translate contentKey="truevocationApp.school.delete.question" interpolate={{ id: schoolEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="-confirm-delete-school" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
