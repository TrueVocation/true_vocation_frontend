    ...
    <Row>
      <Col md="8">
        <h2 data-cy="subjectDetailsHeading">
          <Translate contentKey="truevocationApp.subject.detail.title">Subject</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="truevocationApp.subject.name">Name</Translate>
            </span>
          </dt>
          <dd>{subjectEntity.name}</dd>
          <dt>
            <span id="picture">
              <Translate contentKey="truevocationApp.subject.picture">Picture</Translate>
            </span>
          </dt>
