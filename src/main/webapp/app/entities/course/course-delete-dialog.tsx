...
export const CourseDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="truevocationApp.course.delete.question">
        <Translate contentKey="truevocationApp.course.delete.question" interpolate={{ id: courseEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="-confirm-delete-course" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
