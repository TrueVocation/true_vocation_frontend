...
export const AppUserDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="truevocationApp.appUser.delete.question">
        <Translate contentKey="truevocationApp.appUser.delete.question" interpolate={{ id: appUserEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="-confirm-delete-appUser" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
