...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pictures.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PICTURES_LIST actions', async () => {
    ...
    it('dispatches FETCH_PICTURES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PICTURES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PICTURES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PICTURES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PICTURES actions', async () => {
      const expectedActions = [
        {
