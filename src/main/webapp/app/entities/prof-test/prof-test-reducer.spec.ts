...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './prof-test.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROFTEST_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROFTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROFTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROFTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROFTEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROFTEST actions', async () => {
      const expectedActions = [
        {
